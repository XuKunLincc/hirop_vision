# 1 "simaple_trainer.cpp"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 1 "<command-line>" 2
# 1 "simaple_trainer.cpp"
# 1 "include/simaple_trainer.h" 1



# 1 "./include/itrainer.h" 1
# 24 "./include/itrainer.h"
...
# 26 "./include/itrainer.h" 2

namespace hirop_vision{
# 48 "./include/itrainer.h"
class ITrainer{
...
# 85 "./include/itrainer.h"
    virtual int feedback() = 0;
# 107 "./include/itrainer.h"
...
# 3 "simaple_trainer.cpp" 2

extern "C" { void* __createSimapleTrainer(){ return new className; }}
...
int SimapleTrainer::deleteData(){
    std::cout << "deteting data" << std::endl;
        std::string name = "__create#className";
    return 0;
}
